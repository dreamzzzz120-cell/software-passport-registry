...
import { createPublicPagesRouter } from './src/routes/public-pages.ts';
import { createCustomDomainsRouter } from './src/routes/custom-domains.ts';
import { createTrustVectorRouter } from './src/routes/trust-vector.ts';
...
import { createFreeReviewLeadsRouter } from './src/routes/free-review-leads.ts';
import { createWhitepaperRouter } from './src/routes/whitepaper.ts';
import { createRoiRouter } from './src/routes/roi.ts';
...
app.use('/api', createPublicPagesRouter());
app.use('/api', createCustomDomainsRouter());
app.use('/api/trust-vector', createTrustVectorRouter());
app.use('/api', createFreeReviewRouter());
app.use('/api', createFreeReviewLeadsRouter());
