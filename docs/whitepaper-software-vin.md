...
*Software Passport Registry Ltd. — draft for founder review. Every product claim below describes behaviour that exists in the SPR codebase today; there are no market-size figures or third-party statistics in this document because none were independently verified for it.*
