...
// Public-link minting creates a signed 7-day credential; cap it per client on
// top of the shared /api limiter.
const linkMintLimiter = rateLimit({ windowMs: 60_000, limit: 30, standardHeaders: 'draft-7', legacyHeaders: false, validate: { trustProxy: false } });
