...
export function createConnectRouter() {
  ...
  router.use('/v1/evidence', authenticateApiKey);
  router.use('/v1/risk', authenticateApiKey);
  router.use('/v1/history', authenticateApiKey);
  router.use('/v1/webhooks', authenticateApiKey);
