...
type CommandResponse = { reply?: string; intent?: string; path?: string; action?: { type?: string; endpoint?: string; payload?: Record<string, unknown> }; data?: { counts?: Record<string, number>; topPassports?: Array<{ passport_id: string; name: string; client_id?: string | null; open_findings: number; critical_high: number }>; topClients?: Array<{ id: string; name: string }> }; actions?: Array<{ label: string; command?: string; path?: string }> };
