...
export default function NewReviewIntake() {
  ...
  return <section className="spr-panel p-5 md:p-6" aria-label="Start a new software review">
    <div className="flex flex-col gap-1"><div className="text-[12px] font-bold uppercase tracking-[.2em] text-[var(--spr-highlight)]">New review</div><h2 className="text-xl font-bold text-[var(--spr-text)]">Submit software for analysis</h2><p className="max-w-3xl text-sm text-[var(--spr-text-muted)]">Choose a GitHub repository or upload software and evidence files. Uploads are finalized with SHA-256 before they enter the analysis queue.</p></div>
