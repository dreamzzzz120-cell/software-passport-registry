...
function Security({ onNavigate }: { onNavigate: (path: string) => void }) {
  return <div className="max-w-5xl">
    ...
    <div className="mt-10 grid gap-5 md:grid-cols-2">
      ...
      <Card title="Responsible disclosure">Report a vulnerability to <a className="text-[var(--spr-highlight)] hover:underline" href="mailto:contact@softwarepassportregistry.com">contact@softwarepassportregistry.com</a> or through the <button className="text-[var(--spr-highlight)] hover:underline" onClick={() => onNavigate('/contact/')}>contact form</button> with the “Security report” topic. We acknowledge reports and do not pursue good-faith researchers. See <a className="text-[var(--spr-highlight)] hover:underline" href="https://github.com/dreamzzzz120-cell/software-passport-registry/blob/main/SECURITY.md" rel="noreferrer">SECURITY.md</a>.</Card>
    </div>
  ...
  return <div className="max-w-4xl">
    ...
    <div className="mt-10 grid gap-8 md:grid-cols-[1fr_280px]">
      ...
      <aside className="space-y-4 text-sm leading-6 text-[var(--spr-text-muted)]">
        ...
        <div><div className="text-xs font-semibold uppercase tracking-wide text-[var(--spr-text-faint)]">Security reports</div>Use the form with the “Security report” topic, or the same address.</div>
