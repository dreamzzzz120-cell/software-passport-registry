...
const agents = [
  ...
  { name: 'Vendor Risk Agent', status: 'NEXT', description: 'Will turn vendor evidence, findings, freshness and verification into an operational review.', action: 'Planned', icon: ShieldCheck },
