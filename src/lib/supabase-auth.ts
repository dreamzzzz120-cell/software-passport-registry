...
export async function signInWithPopup(_auth: typeof auth, _provider?: unknown) { await signInWithOAuth('google'); return { user: currentUser }; }
export async function signInWithRedirect(_auth: typeof auth, _provider?: unknown) { await signInWithOAuth('google'); }
