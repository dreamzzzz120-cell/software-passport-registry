...
describe('public API v1 hardening invariants', () => {
  ...
  it('requires write scope for registration and read scope for verification', () => {
  ...
  it('keeps identity uniqueness tenant-scoped', () => {
