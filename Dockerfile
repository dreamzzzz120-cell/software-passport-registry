...
ARG SOURCE_REV=railway-security-hardening-20260820-v1
RUN test "$SOURCE_REV" = "railway-security-hardening-20260820-v1"
COPY . ./
...
EXPOSE 8080
USER 10001:10001
HEALTHCHECK --interval=30s --timeout=5s --start-period=30s --retries=3 CMD curl -fsS "http://127.0.0.1:${PORT:-8080}/ready" || exit 1
